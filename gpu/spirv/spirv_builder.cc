 ...
 ******************************************************************************
 *
 * @modified  high-cut path C, P-2 — ported to ReXGlue/rex:: (namespace + include paths only;
 *            bodies unchanged from Xenia). Implements the SDK's rex::graphics::SpirvBuilder,
 *            whose header ships in the SDK but whose .cc is not. See
